...
class TestPage:
    ...
    def test_get_or_create_component_instance_new(self, mock_quillion, page_with_router):
    ...
    @patch('quillion.core.app.Quillion._instance')
    def test_get_or_create_component_instance_existing(self, mock_quillion, page_with_router):
    ...
    @patch('quillion.core.app.Quillion._instance')
    def test_cleanup_preserves_current_components(self, mock_quillion, page_with_router):
        mock_component1 = Mock(spec=Component)
        mock_component1.key = "key1"
