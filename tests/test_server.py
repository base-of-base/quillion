...
class TestServerConnection:
    ...
    def test_start_creates_websocket_server(self, server_connection, mock_handler, mock_loop):
    ...
    def test_start_uses_default_parameters(self, server_connection, mock_handler, mock_loop):
        with patch('websockets.serve') as mock_serve, \
             patch('asyncio.get_event_loop', return_value=mock_loop):
    ...
    def test_start_with_custom_host_port(self, server_connection, mock_handler, mock_loop):
        with patch('websockets.serve') as mock_serve, \
             patch('asyncio.get_event_loop', return_value=mock_loop):
