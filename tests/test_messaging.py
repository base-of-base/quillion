...
class TestMessaging:
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_callback_sync(
        self, messaging, mock_websocket, mock_callback
    ):
        callback_id = "test_callback_123"
        inner_data = {"action": "callback", "id": callback_id}
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_callback_async(
        self, messaging, mock_websocket, mock_async_callback
    ):
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_callback_not_found(
        self, messaging, mock_websocket
    ):
        inner_data = {"action": "callback", "id": "non_existent_callback"}
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_event_callback_with_data(
        self, messaging, mock_websocket, mock_callback
    ):
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_event_callback_without_data(
        self, messaging, mock_websocket, mock_callback
    ):
        callback_id = "test_event_callback_456"
        inner_data = {"action": "event_callback", "id": callback_id, "event_data": ""}
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_event_callback_no_parameters(
        self, messaging, mock_websocket
    ):
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_event_callback_invalid_json(
        self, messaging, mock_websocket, mock_callback
    ):
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_event_callback_async(
        self, messaging, mock_websocket, mock_async_callback
    ):
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_event_callback_not_found(
        self, messaging, mock_websocket
    ):
        inner_data = {
            "action": "event_callback",
    ...
    async def test_process_inner_message_navigate(self, messaging, mock_websocket):
        test_path = "/test-path"
        inner_data = {"action": "navigate", "path": test_path}
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_navigate_empty_path(
        self, messaging, mock_websocket
    ):
        inner_data = {"action": "navigate", "path": ""}
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_navigate_no_path(
        self, messaging, mock_websocket
    ):
        inner_data = {"action": "navigate"}
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_event_callback_exception(
        self, messaging, mock_websocket, mock_callback
    ):
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_navigate_exception(
        self, messaging, mock_websocket
    ):
        inner_data = {"action": "navigate", "path": "/test"}
    ...
    @pytest.mark.asyncio
    async def test_process_inner_message_event_callback_different_signatures(
        self, messaging, mock_websocket
    ):
