...
class TestComponent:
    ...
    def test_component_initialization_with_tag_and_props(self):
        component = Component("span", id="test", class_name="component", data_custom="value")
        assert component.tag == "span"
        assert component.props == {"id": "test", "class_name": "component", "data_custom": "value"}
    ...
    def test_to_dict_with_inline_styles(self):
        ...
        if "inline_style_properties" in result:
            ...
            assert "color:red" in style_attr.replace(" ", "") or "color: red" in style_attr
